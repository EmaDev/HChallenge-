...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      return this.amigos.map( friend => {
        return friend.nombre;
      })
    }
    ...
    getPromedioEdad() {
      ...
      const totalEdadAmigos = this.amigos.reduce( (acum, act) => {
        return acum + act.edad;
      }, 0);

      return totalEdadAmigos / this.amigos.length;
    }
  };
